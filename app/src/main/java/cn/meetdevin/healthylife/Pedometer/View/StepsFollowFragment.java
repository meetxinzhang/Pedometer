...
public class StepsFollowFragment extends Fragment implements PedometerActivity.OnActivityChangeListener{
    ...
    public static StepsFollowFragment newInstance(int position) {
        StepsFollowFragment f = new StepsFollowFragment();
        Bundle b = new Bundle();
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View rootView = inflater.inflate(R.layout.fragment_pedo_follow,container,false);
